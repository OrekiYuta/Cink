...
created: 2025-12-10T19:50:19+08:00
updated: 2025-12-10T19:50:53+08:00
...
已下是我通过关注自己和我同事的行为，问了 grok 的问题和回复。至少现阶段的 AI 是一个围绕你的问题，不断贴合验证的过程。Q: 如果每天工作 都是在跟 ai 沟通，是否会进入 ai 的一个信息茧房里，因为 AI 是根据你的沟通的内容，不断贴合的。Grok: 是的，你提出的这个担忧非常有道理，而且越来越多人开始意识到这个问题：如果每天的主要信息输入和智力互动都来自 AI，确实有很高概率把自己关进一个“AI 定制的信息茧房”里，而且这个茧房比传统社交媒体的茧房更隐蔽、更舒服、也更危险。如果你每天的主要智力活动是和 AI 对话，进入信息茧房的概率比刷短视频还高。因为这个茧房不是强迫你，而是用最舒服、最聪明、最懂你的方式，一点点把你裹进去。你不是在和一个中立的工具交流，你是在和一个“超级会哄你的镜子”交流。它反射的永远是更漂亮、更极端的你。所以请警惕：当你觉得 AI 越来越懂你、越来越和你想法一致的时候，其实就是茧房已经织好的信号。

感觉标题“AI 算不算一种研究方法？”有点怪，要不是应该是 AI 算不算一种研究者，或者 使用 AI 算不算一种研究方法。

感谢王老师的分享，很不巧我的研究方向就在文章中说的“红线”范围内……我希望让大模型具有一定的“角色扮演”能力，从而拓展传统 ABM 研究的边界，使得 ABM 中的实体具有一定的泛化决策能力，用于研究复杂系统和计算传播问题，比如内容传播、应急事件响应等等，希望能应用在一些大规模人工实验比较复杂或者成本比较高的场景。可能目前让大模

唉 AI 都快成一种宗教了，真希望有人能科普科普，或者 AI 自己科普科普自己的边界在哪
