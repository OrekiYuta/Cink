---
title: "What is WebAuthn and Why It Matters for Authentication"
source: "https://fusionauth.io/blog/what-is-webauthn-why-do-you-care"
author:
  - "[[Dan Moore]]"
  - "[[Ikeh Aakinyemi]]"
  - "[[Don Bergal]]"
  ...
  - "[[Cheryl Hung]]"
published:
created: 2026-01-01T01:41:01+08:00
updated: 2026-01-01T01:42:27+08:00
description: "WebAuthn, short for Web Authentication, is a passwordless, browser-based API. It supports account security with biometrics and public-key cryptography."
category: "it"
tags:
  - "it"
---
...
> [!TIP] Source link: [What is WebAuthn and Why It Matters for Authentication](https://fusionauth.io/blog/what-is-webauthn-why-do-you-care)
...
WebAuthn, short for Web Authentication, is a passwordless, browser-based API. It supports account security with biometrics and public-key cryptography.

![](../../images/what-is-web-authn.png)
...
The type of asymmetric keys that an authenticator supports, how the public key is distributed to the webapp, and how the key pair is used to authenticate a user are all specified by WebAuthn and related standards. [![Download passkeys whitepaper](../../images/passkeys-how.png)](https://fusionauth.io/tech-papers/why-passkeys-improve-user-security-how-to-implement-them?utm_medium=organic&utm_source=blog&utm_campaign=passkeys_whitepaper)
...
Finally, additional factors of authentication, or [MFA](https://fusionauth.io/learn/expert-advice/authentication/multi-factor-authentication) are a common way to increase account security. Your user accounts are more secure when requiring a time based code from a device or other additional factor of authentication. But will your users be okay with the experience? The friction involved in providing the additional factor can cause issues. And remember, you don’t want to get in the way of customers logging in; otherwise you won’t be able to sell them the red clown noses they so desperately desire.
...
![WebAuthn entities.](../../images/webauthn-players.svg)
...
![WebAuthn and CTAP2.](../../images/webauthn-ctap.svg)
...
![Browser support for WebAuthn.](../../images/webauthn-browser-support.png)
...
![WebAuthn login form at Best Buy.](../../images/best-buy-webauthn.png)
